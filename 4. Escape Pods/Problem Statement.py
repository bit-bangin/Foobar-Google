...
================================================================================
                        ====== OBJECTIVES =======
--------------------------------------------------------------------------------
Figure out how many bunnies can make it to the escape pods at a time at peak.
--------------------------------------------------------------------------------
- Write fx. {{ solution(entrances, exits, path) }}
        - Accepts INPUT:
            1. Array of integers:
                - Denoting where the groups of gathered bunnies are.
                    - {entrances}
            2. Array of integers:
                - Denoting where the escape pods are located.
                    - {exits}
            3.  Array of an array of integers:
                - Mapping the corridors.
                    - {path}
        - Returns OUTPUT (int):
            - Total number of bunnies that can get through at each time step

- The entrances and exits are disjointed; thus never overlapping.
- There are at most 50 rooms connected by the corridors
- At most 2000000 bunnies that will fit at a time.

- The path element path[A][B] = C:
    - Describes that the corridor traversing from A to B can fit C bunnies
      at each time step.
--------------------------------------------------------------------------------
Given:
{Entrances}
...
{Path}
How many bunnies can fit through at a time in q direction of q corridor
================================================================================
================================================================================
                        ======= Test cases =======
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
Input:
solution.solution([0], [3], [[0, 7, 0, 0], [0, 0, 6, 0], [0, 0, 0, 8],
[9, 0, 0, 0]])
Output:
    6
